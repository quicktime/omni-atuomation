...
public class BaseState {
	...
	/**
	 * Waits for passed-in locator; default timeout
	...
	/**
	 * Waits for passed-in locator; specified timeout
	 * @param locator - locator to wait for
	 * @param timeOut - timeout in seconds to wait for locator before returning
	 */
	public static void waitForObject(String locator, int timeOut) {
		desktop.waitForObject(locator, timeOut);
	}
}
