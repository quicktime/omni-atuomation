...
/**
 * Handles all test cases for the Re-Installation Tab
 * @author Brendan Dolan
 * @date Created on: Apr 9, 2018
 */
public class ReInstallation {
	
	public static final String sheetsPath = Main.sheetsPath + "D23308 Master Media\\Re-Installation\\REINST-1\\";
	public static final String filesPath = Main.filesPath + "D23308 Master Media\\Re-Installation\\REINST-1\\";
	public static final String databasesPath = Main.databasesPath + "D23308 Master Media\\Re-Installation\\REINST-1\\";
	
	/**
	 * Runs test case REINST-1
	 */
	public static void reinst1Run() {
		Main.debug.LOG("Starting test case REINST-1...");
		...
		// TODO: Do an installation to place omni java onto an instrument with omni java already on it
		Putty.configuration();
		Putty.goToJava();
		Putty.lsL();
		Putty.close();
		...
		Main.debug.LOG("Test case REINST-1 passed!");
	}
